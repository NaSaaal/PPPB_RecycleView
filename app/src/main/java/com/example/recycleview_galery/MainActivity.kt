package com.example.recycleview_galery
...
import com.example.receycleview_galery.R
import com.example.receycleview_galery.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun generatedataDummy(): List<Gallery>{
        return listOf(
            ...
            Gallery("Gallery 6", R.drawable.galeri6),
            Gallery("Gallery 7", R.drawable.galeri7),
        )
    }
}